...
public class MockHandler<T> implements MockitoInvocationHandler, MockHandlerInterface<T> {
  ...
  private boolean isForGroovyGetMetaClass(Method method) {
    return GroovyObject.class.isAssignableFrom(method.getDeclaringClass()) && method.getName().equals("getMetaClass") && method.getParameterTypes().length == 0;
  }
